...
var _utilsAreMomentRangesEqual = require('../utils/areMomentRangesEqual');

var _utilsAreMomentRangesEqual2 = _interopRequireDefault(_utilsAreMomentRangesEqual);
...
describe('The DateRangePicker component', function () {
  ...
  describe('contains CalendarMonth components', function () {
    ...
    describe('which number is', function () {
      it('by default only one', function () {
        ...
        expect(this.renderedComponent.props.children[1][0].type).toBe(_calendarCalendarMonth2['default']);
      });
    ...
    describe('for each component the highlighted date', function () {
      ...
      it('is set to null if it is not a moment', function () {
        ...
        var calendarMonthComponent = _reactAddonsTestUtils2['default'].scryRenderedComponentsWithType(this.renderedComponent, _calendarCalendarMonth2['default'])[0];
        ...
        describe('if state.selectedStartDate is undefined', function () {
          ...
          describe('if the date is not disabled and is selectable', function () {
            ...
            it('if props.singleDateRange is true, it calls #highlightRange', function () {
              ...
              expect((0, _utilsIsMomentRange2['default'])(range)).toBe(true);
              expect((0, _utilsAreMomentRangesEqual2['default'])(range, _moment2['default'].range(this.date, this.date))).toBe(true);
            });
          });
        });
      });
  ...
  describe('contains a Legend component', function () {
    ...
    it('if props.showLegend is defined', function () {
      ...
      expect(legendComponent.type).toBe(_LegendJsx2['default']);
  ...
  describe('#nonSelectableStateRanges', function () {
    ...
    it('returns the expected range', function () {
      ...
      expect((0, _utilsAreMomentRangesEqual2['default'])(list.get(0).get('range'), this.nonSelectableRange)).toBe(true);
    });
  });
  ...
  describe('#sanitizeRange', function () {
    ...
    describe('if forwards is true', function () {
      ...
      it('and if the provided range intersects with the non selectable ranges it returns a smaller range', function () {
        ...
        expect((0, _utilsAreMomentRangesEqual2['default'])(range, _moment2['default'].range((0, _moment2['default'])(new Date(2001, 1, 15)), (0, _moment2['default'])(new Date(2002, 1, 15))))).toBe(true);
      });
      ...
      it('and if the provided range starts before the enabled range it returns a smaller range', function () {
        ...
        expect((0, _utilsAreMomentRangesEqual2['default'])(range, _moment2['default'].range((0, _moment2['default'])(new Date(2001, 1, 15)), (0, _moment2['default'])(new Date(2001, 1, 20))))).toBe(true);
      });
      ...
      it('and if the provided range finishes after the enabled range it returns a smaller range', function () {
        ...
        expect((0, _utilsAreMomentRangesEqual2['default'])(range, _moment2['default'].range((0, _moment2['default'])(new Date(2006, 1, 15)), (0, _moment2['default'])(new Date(2001, 1, 20))))).toBe(true);
      });
      ...
      it('otherwise it returns the full range', function () {
        ...
        expect((0, _utilsAreMomentRangesEqual2['default'])(range, _moment2['default'].range((0, _moment2['default'])(new Date(2001, 1, 15)), (0, _moment2['default'])(new Date(2001, 1, 17))))).toBe(true);
      });
    });
    ...
    describe('otherwise', function () {
      it('and if the provided range intersects with the non selectable ranges it returns a smaller range', function () {
        ...
        expect((0, _utilsAreMomentRangesEqual2['default'])(range, _moment2['default'].range((0, _moment2['default'])(new Date(2003, 1, 15)), (0, _moment2['default'])(new Date(2005, 1, 15))))).toBe(true);
      });
